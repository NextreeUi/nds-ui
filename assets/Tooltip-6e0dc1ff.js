import{j as t,s as a,r as c,B as n}from"./index-69d055d0.js";import{R as l,j as r}from"./index-10df7ccd.js";import{T as k}from"./Table-a8f80f1c.js";const i=({content:h,placement:o="bottom",bg:s="grayc",color:e,radius:m="normal",size:d="medium",children:p,className:u})=>{s=="black"||s=="gray1"||s=="gray2"||s=="gray3"||s=="gray4"||s=="gray5"||s=="gray6"||s=="gray7"||s=="gray8"||s=="gray9"?e=e||"white":(s=="graya"||s=="grayb"||s=="grayc"||s=="grayd"||s=="graye"||s=="grayf5"||s=="grayf8"||s=="white")&&(e=e||"black");const j=x=>x?a[`bg-${x}`]:"";return t.jsx(t.Fragment,{children:t.jsxs("div",{className:a["tooltip-wrap"],children:[t.jsx("div",{className:a.children,children:p}),t.jsx("div",{className:a.tooltip+" "+(o=="top-start"?a["placement-top-start"]:o=="top"?a["placement-top"]:o=="top-end"?a["placement-top-end"]:o=="right-start"?a["placement-right-start"]:o=="right"?a["placement-right"]:o=="right-end"?a["placement-right-end"]:o=="bottom-start"?a["placement-bottom-start"]:o=="bottom"?a["placement-bottom"]:o=="bottom-end"?a["placement-bottom-end"]:o=="left-start"?a["placement-left-start"]:o=="left"?a["placement-left"]:o=="left-end"?a["placement-left-end"]:"")+" "+(m=="rect"?a["radius-rect"]:m=="normal"?a["radius-normal"]:m=="round"?a["radius-round"]:"")+" "+(d=="large"?a["size-large"]:d=="medium"?a["size-medium"]:d=="small"?a["size-small"]:d=="extraSmall"?a["size-extraSmall"]:"")+" "+(e=="black"?a["color-black"]:e=="white"?a["color-white"]:"")+" "+j(s)+" "+(u||""),children:h})]})})},R=()=>{const h=c.useRef(),o=c.useRef(),s=c.useRef(),[e,m]=c.useState(!1),d=()=>{m(!e)},[p,u]=c.useState(!1),j=()=>{u(!p)},[x,f]=c.useState(!1),N=()=>{f(!x)},[B,b]=c.useState(!1),g=()=>{b(!B)},[v,y]=c.useState(!1),T=()=>{y(!v)};return c.useState(!1),t.jsx(t.Fragment,{children:t.jsxs("div",{className:"layout-all",children:[t.jsxs("div",{className:"layout-title",children:[t.jsx("h1",{children:"Tooltip"}),t.jsx("p",{className:"description",children:"Tooltip 컴포넌트는 호버시 나타나는 안내문입니다."})]}),t.jsx("div",{className:"layout-small",children:t.jsxs("div",{className:"layout-title",children:[t.jsx("h2",{ref:h,children:"Import"}),t.jsx("div",{className:"codeMirror",children:t.jsx(l,{theme:"dark",extensions:[r({jsx:!0})],value:`import { Tooltip } from 'nds-ui/component';
// or
import Tooltip from 'nds-ui/component/Tooltip';`})}),t.jsxs("p",{className:"description",children:["임포트 방법은 2가지가 있습니다. ",t.jsx("br",{}),"첫번째 방식은 여러개의 컴포넌트를 임포트하는데 유리합니다. ",t.jsx("br",{}),"임포트 방식은 취향에 맞게 사용하시면 됩니다."]})]})}),t.jsx("div",{className:"layout-small",children:t.jsxs("div",{className:"layout-title",children:[t.jsx("h2",{ref:o,children:"Property"}),t.jsxs("p",{className:"description",children:["Tooltip 컴포넌트 안에는 다양한 속성들이 있습니다. ",t.jsx("br",{}),"content / placement / bg / color / radius / size 등 다양한 속성들이 있는데, 그 사용법을 알아보겠습니다."]})]})}),t.jsxs("div",{className:"layout-small",children:[t.jsxs("div",{className:"layout-title",children:[t.jsx("h3",{children:"Content"}),t.jsx("p",{className:"description",children:"content 속성은 Tooltip의 내용을 정하는 속성입니다."})]}),t.jsx("div",{className:"layout-example",children:t.jsx(i,{content:"Tooltip",children:t.jsx(n,{variant:"contained",children:"Hover"})})}),t.jsxs("div",{className:"codeMirror",children:[t.jsx("div",{className:"btn-wrap",children:t.jsx(n,{square:!0,radius:"round",variant:"outlined",size:"extraSmall",hoverBg:"white",hoverColor:"black",theme:"white",onClick:d,children:t.jsx("i",{className:"i-code w14 h14"})})}),e?t.jsx(l,{theme:"dark",extensions:[r({jsx:!0})],value:`import * as React from 'react';
