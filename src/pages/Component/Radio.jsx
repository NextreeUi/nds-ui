...
import { Radio, Button, Table } from '@/nds-ui/component';
    ...
    <>
      <div className='layout-all'>
        ...
        <div className='layout-title'>
          <h1>Radio</h1>
          <p className='description'>클릭 인터렉션이 있는 Radio 컴포넌트입니다.</p>
        </div>
...
// or
import Radio from 'nds-ui/component/Radio';`}/>
            </div>
        ...
        <div className='layout-small'>
          <div className='layout-title'>
            ...
            <p className='description'>
              Radio 컴포넌트 안에는 다양한 속성들이 있습니다. <br/>
        ...
        <div className='layout-small'>
          <div className='layout-title'>
            <h3>Theme</h3>
            <p className='description'>
              theme 속성으로 라디오박스의 컬러를 설정할 수 있습니다. <br/>
...
<Radio name='radioTheme' theme='tertiary' />
        ...
        <div className='layout-small'>
          <div className='layout-title'>
            <h3>Size</h3>
            <p className='description'>
              size 속성으로 라디오박스의 크기를 설정할 수 있습니다. <br/>
...
<Radio name='radioSize' size='extraSmall'/>
        ...
        <div className='layout-small'>
          <div className='layout-title'>
            <h3>Color</h3>
            <p className='description'>
              color 속성으로 라디오박스의 색상을 설정할 수 있습니다. <br/>
...
<Radio name='radioColor'  color='tertiary' />
        ...
        <div className='layout-small'>
          <div className='layout-title'>
            <h3>Ripple</h3>
            <p className='description'>
              ripple 속성으로 라디오박스의 인터렉션 색상을 설정할 수 있습니다. <br/>
...
<Radio defaultChecked />
        ...
        <div className='layout-small'>
          <div className='layout-title'>
            <h3>Disabled</h3>
            <p className='description'>
              disabled 속성으로 라디오박스를 비활성화 할 수 있습니다. 
            </p>
          </div>
          <div className='layout-example'>
            <Radio />
