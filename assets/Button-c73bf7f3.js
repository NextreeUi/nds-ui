import{r as a,j as e,B as t}from"./index-da110f41.js";import{R as s,j as r}from"./index-ca17e846.js";import{h as ie}from"./index-0e192cf3.js";import{T as le}from"./Table-599eed7f.js";const me=()=>{const o=a.useRef(),i=a.useRef(),l=a.useRef(),n=a.useRef(),[d,g]=a.useState(!1),S=()=>{g(!d)},[c,R]=a.useState(!1),E=()=>{R(!c)},[u,H]=a.useState(!1),z=()=>{H(!u)},[m,O]=a.useState(!1),q=()=>{O(!m)},[h,M]=a.useState(!1),$=()=>{M(!h)},[x,V]=a.useState(!1),D=()=>{V(!x)},[j,I]=a.useState(!1),P=()=>{I(!j)},[v,T]=a.useState(!1),G=()=>{T(!v)},[p,A]=a.useState(!1),F=()=>{A(!p)},[B,L]=a.useState(!1),_=()=>{L(!B)},[N,J]=a.useState(!1),W=()=>{J(!N)},[C,X]=a.useState(!1),K=()=>{X(!C)},[y,Q]=a.useState(!1),U=()=>{Q(!y)},[b,Y]=a.useState(!1),Z=()=>{Y(!b)},[f,ee]=a.useState(!1),te=()=>{ee(!f)},[k,se]=a.useState(!1),re=()=>{se(!k)},[w,ae]=a.useState(!1),oe=()=>{ae(!w)};return e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Button"}),e.jsx("p",{className:"description",children:"클릭 인터렉션이 있는 Button 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:o,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(s,{theme:"dark",extensions:[r({jsx:!0})],value:`import { Button } from 'nds-ui/component';
// or
import Button from 'nds-ui/component/Button';`})}),e.jsxs("p",{className:"description",children:["임포트 방법은 2가지가 있습니다. ",e.jsx("br",{}),"첫번째 방식은 여러개의 컴포넌트를 임포트하는데 유리합니다. ",e.jsx("br",{}),"임포트 방식은 취향에 맞게 사용하시면 됩니다."]})]})}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:i,children:"Property"}),e.jsxs("p",{className:"description",children:["Button 컴포넌트 안에는 다양한 속성들이 있습니다. ",e.jsx("br",{}),"variant / theme / size / radius / square / shadow / bg / otl / color / ripple / hoverBg / hoverOtl / hoverColor / hoverRadius / disabled 등 다양한 속성들이 있는데, 그 사용법을 알아보겠습니다."]})]})}),e.jsxs("div",{className:"layout-small",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h3",{children:"Variant"}),e.jsx("p",{className:"description",children:"variant 속성으로 버튼의 종류를 설정할 수 있습니다."})]}),e.jsxs("div",{className:"layout-example",children:[e.jsx(t,{children:" Noraml "}),e.jsx(t,{variant:"outlined",children:" Outlined  "}),e.jsx(t,{variant:"contained",children:" Contained "})]}),e.jsxs("div",{className:"codeMirror",children:[e.jsx("div",{className:"btn-wrap",children:e.jsx(t,{square:!0,radius:"round",variant:"outlined",size:"extraSmall",hoverBg:"white",hoverColor:"black",theme:"white",onClick:S,children:e.jsx("i",{className:"i-code w14 h14"})})}),d?e.jsx(s,{theme:"dark",extensions:[r({jsx:!0})],value:`import * as React from 'react';
...
<Button variant='contained'> Normal </Button>
<Button disabled variant='contained'> Disabled </Button>
</>`})]})]}),e.jsxs("div",{className:"layout-small",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:l,children:" Custom Example "}),e.jsxs("p",{className:"description",children:["여러가지 속성을 사용하여 버튼을 원하시는대로 커스텀할 수 있습니다. ",e.jsx("br",{}),"bg / otl / color / ripple / hoverBg / hoverOtl / hoverColor 등이 있습니다. ",e.jsx("br",{}),"이 중 bg / otl / color / ripple / hoverBg 속성은 theme 속성을 통해 동시에 컨트롤 가능하지만, 더 세부적인 컨트롤을 원하실 경우 사용하시면 됩니다."]})]}),e.jsx("div",{className:"layout-example",children:e.jsx(t,{variant:"contained",bg:"white",otl:"primary",color:"primary",hoverBg:"primary",hoverColor:"white",hoverRipple:"white",children:"Custom"})}),e.jsxs("div",{className:"codeMirror",children:[e.jsx("div",{className:"btn-wrap",children:e.jsx(t,{square:!0,radius:"round",variant:"outlined",size:"extraSmall",hoverBg:"white",hoverColor:"black",theme:"white",onClick:G,children:e.jsx("i",{className:"i-code w14 h14"})})}),v?e.jsx(s,{theme:"dark",extensions:[r({jsx:!0})],value:`import * as React from 'react';
import { Button } from 'nds-ui/component';
import 'nds-ui/css/style.scss';
...
export default Example;`}):e.jsx(s,{theme:"dark",extensions:[r({jsx:!0})],value:`<>
<Button className='custom-button' variant='contained' radius='round'> Custom </Button>
</>`})]}),e.jsxs("div",{className:`codeMirror ${w?"maxh1000":"maxh300"}`,children:[e.jsxs("div",{className:"btn-wrap",children:[e.jsx("p",{children:"CSS"}),e.jsx(t,{square:!0,radius:"round",variant:"outlined",size:"extraSmall",hoverBg:"white",hoverColor:"black",theme:"white",onClick:oe,children:e.jsx("i",{className:"i-code w14 h14"})})]}),e.jsx(s,{theme:"dark",extensions:[ie({html:!0})],value:`<style>
.custom-button {
