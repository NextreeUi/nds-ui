import{r as a,j as e,B as t}from"./index-eb9b13ca.js";import{R as s}from"./index-684ab6c5.js";import{j as r}from"./index-0f57b3d8.js";import{h as ne}from"./index-26a6535b.js";import{T as ie}from"./Table-5b5073f2.js";import"./index-c561d07a.js";const he=()=>{const o=a.useRef(),n=a.useRef(),i=a.useRef(),l=a.useRef(),[d,S]=a.useState(!1),w=()=>{S(!d)},[c,R]=a.useState(!1),E=()=>{R(!c)},[u,H]=a.useState(!1),z=()=>{H(!u)},[m,O]=a.useState(!1),q=()=>{O(!m)},[x,M]=a.useState(!1),$=()=>{M(!x)},[h,V]=a.useState(!1),D=()=>{V(!h)},[j,I]=a.useState(!1),P=()=>{I(!j)},[p,T]=a.useState(!1),G=()=>{T(!p)},[v,A]=a.useState(!1),F=()=>{A(!v)},[B,L]=a.useState(!1),_=()=>{L(!B)},[N,J]=a.useState(!1),W=()=>{J(!N)},[y,X]=a.useState(!1),K=()=>{X(!y)},[C,Q]=a.useState(!1),U=()=>{Q(!C)},[b,Y]=a.useState(!1),Z=()=>{Y(!b)},[f,ee]=a.useState(!1),te=()=>{ee(!f)},[k,se]=a.useState(!1),re=()=>{se(!k)},[g,ae]=a.useState(!1),oe=()=>{ae(!g)};return e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Button"}),e.jsx("p",{className:"description",children:"클릭 인터렉션이 있는 Button 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:o,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(s,{theme:"dark",extensions:[r({jsx:!0})],value:`import { Button } from 'nds-ui/component';
// or
