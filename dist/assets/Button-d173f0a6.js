import{r as a,j as e,B as t}from"./index-69d055d0.js";import{R as s,j as r}from"./index-10df7ccd.js";import{h as ie}from"./index-0d0a0aaa.js";import{T as le}from"./Table-a8f80f1c.js";const me=()=>{const o=a.useRef(),i=a.useRef(),l=a.useRef(),n=a.useRef(),[d,g]=a.useState(!1),S=()=>{g(!d)},[c,R]=a.useState(!1),E=()=>{R(!c)},[u,H]=a.useState(!1),z=()=>{H(!u)},[m,O]=a.useState(!1),q=()=>{O(!m)},[h,M]=a.useState(!1),$=()=>{M(!h)},[x,V]=a.useState(!1),D=()=>{V(!x)},[j,I]=a.useState(!1),P=()=>{I(!j)},[v,T]=a.useState(!1),G=()=>{T(!v)},[p,A]=a.useState(!1),F=()=>{A(!p)},[B,L]=a.useState(!1),_=()=>{L(!B)},[N,J]=a.useState(!1),W=()=>{J(!N)},[C,X]=a.useState(!1),K=()=>{X(!C)},[y,Q]=a.useState(!1),U=()=>{Q(!y)},[b,Y]=a.useState(!1),Z=()=>{Y(!b)},[f,ee]=a.useState(!1),te=()=>{ee(!f)},[k,se]=a.useState(!1),re=()=>{se(!k)},[w,ae]=a.useState(!1),oe=()=>{ae(!w)};return e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Button"}),e.jsx("p",{className:"description",children:"클릭 인터렉션이 있는 Button 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:o,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(s,{theme:"dark",extensions:[r({jsx:!0})],value:`import { Button } from 'nds-ui/component';
// or
