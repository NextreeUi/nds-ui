import{j as e,s as r,r as o,B as t}from"./index-26bff6e6.js";import{R as n,j as s}from"./index-3267b1b1.js";import{A as M}from"./Avatar-c37750b9.js";import{T as I}from"./Table-c1dd1d21.js";const a=({color:j="notification",radius:i="round",vertical:c="top",horizontal:l="right",content:d,max:x,dot:u,children:B,id:v,className:m})=>{const p=h=>h?r[`color-${h}`]:"";return x&&d>x&&(d=x+"+"),e.jsx(e.Fragment,{children:e.jsxs("div",{className:r["badge-wrap"],children:[B,e.jsx("div",{className:r.badge+" "+p(j)+" "+(i=="rect"?r["radius-rect"]:i=="normal"?r["radius-normal"]:i=="round"?r["radius-round"]:"")+" "+(c=="top"?r["vertical-top"]:c=="bottom"?r["vertical-bottom"]:"")+" "+(l=="left"?r["horizontal-left"]:l=="right"?r["horizontal-right"]:"")+" "+(u?r.dot:"")+" "+(m||""),id:v,children:u?"":d})]})})},F=()=>{const j=o.useRef(),i=o.useRef(),c=o.useRef(),[l,d]=o.useState(!1),x=()=>{d(!l)},[u,B]=o.useState(!1),v=()=>{B(!u)},[m,p]=o.useState(!1),h=()=>{p(!m)},[g,C]=o.useState(!1),y=()=>{C(!g)},[N,k]=o.useState(!1),w=()=>{k(!N)},[f,R]=o.useState(!1),z=()=>{R(!f)},[b,E]=o.useState(!1),S=()=>{E(!b)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Badge"}),e.jsx("p",{className:"description",children:"Badge 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:j,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(n,{theme:"dark",extensions:[s({jsx:!0})],value:`import { Badge } from 'nds-ui/component';
// or
