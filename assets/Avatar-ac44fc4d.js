import{r as n,j as e,B as l}from"./index-e690ac9b.js";import{R as a,j as r}from"./index-6fc11d1a.js";import{A as s}from"./Avatar-a67028da.js";import{T as y}from"./Table-3da10440.js";const w=()=>{const i=n.useRef(),d=n.useRef(),m=n.useRef(),[c,u]=n.useState(!1),h=()=>{u(!c)},[o,v]=n.useState(!1),p=()=>{v(!o)};n.useState(!1);const[x,b]=n.useState(!1),N=()=>{b(!x)},[t,A]=n.useState(!1),j=()=>{A(!t)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Avatar"}),e.jsx("p",{className:"description",children:"Avatar 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:i,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(a,{theme:"dark",extensions:[r({jsx:!0})],value:`import { Avatar } from 'nds-ui/component';
// or
