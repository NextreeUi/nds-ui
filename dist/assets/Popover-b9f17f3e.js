...
</>`})]})]}),e.jsxs("div",{className:"layout-small",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:c,children:" API "}),e.jsx("p",{className:"description",children:"속성들을 정리한 테이블입니다."})]}),e.jsx(E,{classWrap:"table-props",colGroup:e.jsxs(e.Fragment,{children:[e.jsx("col",{className:"table-props-col1"}),e.jsx("col",{className:"table-props-col2"})]}),tHead:e.jsx(e.Fragment,{children:e.jsxs("tr",{children:[e.jsx("th",{children:"props"}),e.jsx("th",{children:e.jsx("div",{className:"table-props-value",children:"value"})}),e.jsx("th",{children:"description"})]})}),classTBody:"table-props",tBody:e.jsxs(e.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{children:"open"}),e.jsx("td",{children:"boolean"}),e.jsxs("td",{children:["Backdrop을 나타내는 속성으로 불리언(Boolean) 타입입니다. ",e.jsx("br",{}),"속성값은 true / false 를 자유자재로 변경 가능한 state를 넣어주세요."]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"onClose"}),e.jsx("td",{children:"func"}),e.jsxs("td",{children:["Backdrop을 사라지게 하는 속성으로 함수 명령어가 들어갑니다. ",e.jsx("br",{}),"속성값은 open에 들어간 state 값이 false가 되도록 명령어를 넣어주세요."]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"X"}),e.jsxs("td",{children:["'leftEnd' ",e.jsx("br",{}),e.jsx("p",{className:"b",children:"'left'"}),"'center' ",e.jsx("br",{}),"'right' ",e.jsx("br",{}),"'rightEnd'"]}),e.jsx("td",{children:"가로 위치를 정하는 속성입니다."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"X"}),e.jsxs("td",{children:["'topEnd' ",e.jsx("br",{}),"'top' ",e.jsx("br",{}),"'center' ",e.jsx("br",{}),"'bottom'",e.jsx("p",{className:"b",children:"'bottomEnd'"})]}),e.jsx("td",{children:"세로 위치를 정하는 속성입니다."})]})]})})]}),e.jsxs("div",{className:"layout-scroll",children:[e.jsx("p",{children:"Content"}),e.jsx("a",{onClick:()=>{o.current.scrollIntoView()},children:" Import"}),e.jsx("a",{onClick:()=>{n.current.scrollIntoView()},children:" Property"}),e.jsx("a",{onClick:()=>{c.current.scrollIntoView()},children:" API"})]})]})})};export{O as default};
