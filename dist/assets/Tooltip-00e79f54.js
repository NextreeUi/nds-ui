import{j as t,s as a,r as c,B as n}from"./index-26bff6e6.js";import{R as o,j as r}from"./index-3267b1b1.js";import{T as k}from"./Table-c1dd1d21.js";const i=({content:p,placement:l="bottom",bg:s="grayc",color:e,radius:m="normal",size:d="medium",children:u,className:h})=>{s=="black"||s=="gray1"||s=="gray2"||s=="gray3"||s=="gray4"||s=="gray5"||s=="gray6"||s=="gray7"||s=="gray8"||s=="gray9"?e=e||"white":(s=="graya"||s=="grayb"||s=="grayc"||s=="grayd"||s=="graye"||s=="grayf5"||s=="grayf8"||s=="white")&&(e=e||"black");const j=x=>x?a[`bg-${x}`]:"";return t.jsx(t.Fragment,{children:t.jsxs("div",{className:a["tooltip-wrap"],children:[t.jsx("div",{className:a.children,children:u}),t.jsx("div",{className:a.tooltip+" "+(l=="top-start"?a["placement-top-start"]:l=="top"?a["placement-top"]:l=="top-end"?a["placement-top-end"]:l=="right-start"?a["placement-right-start"]:l=="right"?a["placement-right"]:l=="right-end"?a["placement-right-end"]:l=="bottom-start"?a["placement-bottom-start"]:l=="bottom"?a["placement-bottom"]:l=="bottom-end"?a["placement-bottom-end"]:l=="left-start"?a["placement-left-start"]:l=="left"?a["placement-left"]:l=="left-end"?a["placement-left-end"]:"")+" "+(m=="rect"?a["radius-rect"]:m=="normal"?a["radius-normal"]:m=="round"?a["radius-round"]:"")+" "+(d=="large"?a["size-large"]:d=="medium"?a["size-medium"]:d=="small"?a["size-small"]:d=="extraSmall"?a["size-extraSmall"]:"")+" "+(e=="black"?a["color-black"]:e=="white"?a["color-white"]:"")+" "+j(s)+" "+(h||""),children:p})]})})},R=()=>{const p=c.useRef(),l=c.useRef(),s=c.useRef(),[e,m]=c.useState(!1),d=()=>{m(!e)},[u,h]=c.useState(!1),j=()=>{h(!u)},[x,f]=c.useState(!1),N=()=>{f(!x)},[B,y]=c.useState(!1),b=()=>{y(!B)},[v,g]=c.useState(!1),T=()=>{g(!v)};return c.useState(!1),t.jsx(t.Fragment,{children:t.jsxs("div",{className:"layout-all",children:[t.jsxs("div",{className:"layout-title",children:[t.jsx("h1",{children:"Tooltip"}),t.jsx("p",{className:"description",children:"Tooltip 컴포넌트는 호버시 나타나는 안내문입니다."})]}),t.jsx("div",{className:"layout-small",children:t.jsxs("div",{className:"layout-title",children:[t.jsx("h2",{ref:p,children:"Import"}),t.jsx("div",{className:"codeMirror",children:t.jsx(o,{theme:"dark",extensions:[r({jsx:!0})],value:`import { Tooltip } from 'nds-ui/component';
// or
