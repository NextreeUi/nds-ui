import{r,j as s,s as l,B as x}from"./index-eb9b13ca.js";import{R as e}from"./index-684ab6c5.js";import{j as c}from"./index-0f57b3d8.js";import{T as w}from"./Table-5b5073f2.js";const i=({wrap:m,title:n,icon:o,iconLocation:t="right",iconRotate:j,children:h,id:p,className:a})=>{const[d,u]=r.useState(!1),v=()=>{u(!d)};return s.jsx(s.Fragment,{children:m?s.jsx("div",{className:l["accordion-wrap"]+" "+(a||""),children:h}):s.jsxs(s.Fragment,{children:[s.jsxs("div",{className:l["accordion-summary"]+" "+(t=="left"?l["icon-left"]:"")+" "+(a||""),id:p,onClick:v,children:[t=="right"?n:s.jsx(s.Fragment,{}),s.jsx("div",{className:d?l[`${j||o||"deg180"}`]:"",children:o||s.jsx("i",{className:l.arrow})}),t=="left"?n:s.jsx(s.Fragment,{})]}),s.jsx("div",{className:l["accordion-detail"]+" "+(d?"":l.close),children:h})]})})},R=()=>{const m=r.useRef(),n=r.useRef(),o=r.useRef(),[t,j]=r.useState(!1),h=()=>{j(!t)},[p,a]=r.useState(!1),d=()=>{a(!p)},[u,v]=r.useState(!1),A=()=>{v(!u)},[N,f]=r.useState(!1),y=()=>{f(!N)};return s.jsx(s.Fragment,{children:s.jsxs("div",{className:"layout-all",children:[s.jsxs("div",{className:"layout-title",children:[s.jsx("h1",{children:"Accordion"}),s.jsx("p",{className:"description",children:"Accordion은 클릭시 확장되는 컴포넌트입니다."})]}),s.jsx("div",{className:"layout-small",children:s.jsxs("div",{className:"layout-title",children:[s.jsx("h2",{ref:m,children:"Import"}),s.jsx("div",{className:"codeMirror",children:s.jsx(e,{theme:"dark",extensions:[c({jsx:!0})],value:`import { Accordion } from 'nds-ui/component';
// or
