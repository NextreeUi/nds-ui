import{r as s,j as e,s as d,B as r}from"./index-26bff6e6.js";import{R as t,j as i}from"./index-3267b1b1.js";import{T as M}from"./Table-c1dd1d21.js";const R=({left:a})=>e.jsx(r,{className:d["slide-btn"]+" "+(a?d.left:""),square:!0,size:"large",variant:"contained",bg:"white",color:"black",hoverBg:"grayc-100",hoverColor:"white",ripple:"white",radius:"round",shadow:!0,children:e.jsx("p",{})}),o=({content:a,leftBtn:j,rightBtn:u,noNav:N,pauseIcon:g,playIcon:y,autoSlide:b=!0,delay:C=3e3,noPause:B,classSlide:v,classBtn:w,classNavWrap:f,classNav:p})=>{const[l,c]=s.useState(1),m=s.useRef(),I=()=>{l==1?c(a.length):c(l-1)},P=()=>{l==a.length?c(1):c(l+1)};s.useEffect(()=>{m.current.style.marginLeft=`${100-l*100}%`,m.current.style.width=`${a.length*100}%`});const[x,E]=s.useState(b);function k(h,n){const S=s.useRef();s.useEffect(()=>{S.current=h},[h]),s.useEffect(()=>{function z(){S.current()}if(n!==null){let A=setInterval(z,n);return()=>clearInterval(A)}},[n,l])}return x?k(()=>{l==a.length?c(1):c(l+1)},C):k(()=>{},null),e.jsx(e.Fragment,{children:e.jsxs("div",{className:d["slide-wrap"]+" "+(v||""),children:[e.jsx("div",{ref:m,className:d.slide,children:a}),e.jsxs("div",{className:d["slide-btn-wrap"]+" "+(w||""),children:[e.jsx("div",{onClick:I,children:j||e.jsx(R,{left:!0})}),e.jsx("div",{onClick:P,children:u||e.jsx(R,{})})]}),N?e.jsx(e.Fragment,{}):e.jsxs("div",{className:d["slide-nav-wrap"]+" "+(f||""),children:[a.map((h,n)=>e.jsx("div",{className:d["slide-nav"]+" "+(l==n+1?d.select:"")+" "+(p||""),onClick:()=>{c(n+1)}},n)),B?e.jsx(e.Fragment,{}):e.jsx("div",{onClick:()=>{E(!x)},children:x?g||e.jsx("i",{className:d["slide-nav-pause"]}):y||e.jsx("i",{className:d["slide-nav-play"]})})]})]})})},T=()=>{const a=s.useRef(),j=s.useRef(),u=s.useRef(),[N,g]=s.useState(!1),y=()=>{g(!N)},[b,C]=s.useState(!1),B=()=>{C(!b)},[v,w]=s.useState(!1),f=()=>{w(!v)},[p,l]=s.useState(!1),c=()=>{l(!p)},[m,I]=s.useState(!1),P=()=>{I(!m)},[x,E]=s.useState(!1),k=()=>{E(!x)},[h,n]=s.useState(!1),S=()=>{n(!h)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Slide"}),e.jsx("p",{className:"description",children:"Slide는 화면을 좌우로 이동시키는 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:a,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(t,{theme:"dark",extensions:[i({jsx:!0})],value:`import { Slide } from 'nds-ui/component';
// or
