import{r as l,j as e,B as t}from"./index-8d8aab8b.js";import{R as s}from"./index-c6790d43.js";import{j as a}from"./index-002488c9.js";import{T as B}from"./Table-a3d3663c.js";import{T as r}from"./TextArea-946dafca.js";const q=()=>{const d=l.useRef(),i=l.useRef(),c=l.useRef(),[n,v]=l.useState(!1),f=()=>{v(!n)},[o,N]=l.useState(!1),C=()=>{N(!o)},[x,y]=l.useState(!1),T=()=>{y(!x)},[m,A]=l.useState(!1),b=()=>{A(!m)},[u,k]=l.useState(!1),w=()=>{k(!u)},[j,R]=l.useState(!1),g=()=>{R(!j)},[h,V]=l.useState(!1),S=()=>{V(!h)},[p,E]=l.useState(!1),M=()=>{E(!p)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"TextArea"}),e.jsx("p",{className:"description",children:"TextArea 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:d,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(s,{theme:"dark",extensions:[a({jsx:!0})],value:`import { TextArea } from 'nds-ui/component';
// or
