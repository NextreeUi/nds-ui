import{r as i,j as e,s,B as m}from"./index-649ecee2.js";import{R as a,j as t}from"./index-0fbf75df.js";import{T as g}from"./Table-3f4182fa.js";const l=({size:r="medium",radius:d="normal",defaultValue:x=0,list:j=["데이터를 입력해주세요"],disabled:h=!1,className:p})=>{const o=j,[f,N]=i.useState(x),S=o[f],[b,n]=i.useState(!1),v=()=>{h==!1&&n(!0)},C=c=>{N(c),n(!1)},k=()=>{n(!1)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:s["select-wrap"]+" "+(p||""),children:[e.jsxs("button",{className:s.select+" "+(b?s.focus:"")+" "+(d=="rect"?s["radius-rect"]:d=="normal"?s["radius-normal"]:d=="round"?s["radius-round"]:"")+" "+(r=="large"?s["size-large"]:r=="medium"?s["size-medium"]:r=="small"?s["size-small"]:r=="extraSmall"?s["size-extraSmall"]:"")+" "+(h?s.disabled:""),onClick:v,children:[S,e.jsx("div",{className:s["select-icon"],children:e.jsx("i",{})})]}),e.jsx("ul",{className:s["select-option"],children:o.map((c,u)=>e.jsx("li",{className:s.option+" "+(u==f?s.active:""),onClick:()=>{C(u)},children:e.jsx("div",{children:c})},u))}),e.jsx("div",{className:s["select-backdrop"],onClick:k})]})})},R=()=>{const r=i.useRef(),d=i.useRef(),x=i.useRef(),[j,h]=i.useState(!1),p=()=>{h(!j)},[o,f]=i.useState(!1),N=()=>{f(!o)},[S,b]=i.useState(!1),n=()=>{b(!S)},[v,C]=i.useState(!1),k=()=>{C(!v)},[c,u]=i.useState(!1),y=()=>{u(!c)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Select"}),e.jsx("p",{className:"description",children:"Select 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:r,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(a,{theme:"dark",extensions:[t({jsx:!0})],value:`import { Select } from 'nds-ui/component';
// or
...
<Select list={['default0', 'default1', 'default2']} />
<Select list={['disabled0', 'disabled1', 'disabled2']} disabled/>
</>`})]})]}),e.jsxs("div",{className:"layout-small",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:x,children:" API "}),e.jsx("p",{className:"description",children:"속성들을 정리한 테이블입니다."})]}),e.jsx(g,{classWrap:"table-props",colGroup:e.jsxs(e.Fragment,{children:[e.jsx("col",{className:"table-props-col1"}),e.jsx("col",{className:"table-props-col2"})]}),tHead:e.jsx(e.Fragment,{children:e.jsxs("tr",{children:[e.jsx("th",{children:"props"}),e.jsx("th",{children:e.jsx("div",{className:"table-props-value",children:"value"})}),e.jsx("th",{children:"description"})]})}),classTBody:"table-props",tBody:e.jsxs(e.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{children:"size"}),e.jsxs("td",{children:["'large' ",e.jsx("br",{}),e.jsx("p",{className:"b",children:"'medium'"}),"'small' 'extraSmall'"]}),e.jsx("td",{children:"크기를 조절하는 값입니다."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"raidus"}),e.jsxs("td",{children:["'rect' ",e.jsx("br",{}),e.jsx("p",{className:"b",children:"'normal'"}),"'round'"]}),e.jsx("td",{children:"굴곡을 조절하는 값입니다."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"disabled"}),e.jsx("td",{children:"boolean"}),e.jsxs("td",{children:["비활성화 속성으로 불리언(Boolean) 타입입니다. ",e.jsx("br",{}),"속성값은 따로 없고, 속성을 추가할 시 기본값인 false에서 true로 바뀝니다."]})]})]})})]}),e.jsxs("div",{className:"layout-scroll",children:[e.jsx("p",{children:"Content"}),e.jsx("a",{onClick:()=>{r.current.scrollIntoView()},children:" Import"}),e.jsx("a",{onClick:()=>{d.current.scrollIntoView()},children:" Property"}),e.jsx("a",{onClick:()=>{x.current.scrollIntoView()},children:" API"})]})]})})};export{R as default};
