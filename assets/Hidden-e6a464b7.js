...
<Hidden max={1800} className='flexCenter width100 r10 h30  bgc-secondary txt-white size20 b'> Max 1800 </Hidden>
<Hidden max={2000} className='flexCenter width100 r10 h30  bgc-tertiary txt-white size20 b'> Max 2000 </Hidden>
</>`})]})]}),e.jsxs("div",{className:"layout-small",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:c,children:" API "}),e.jsx("p",{className:"description",children:"속성들을 정리한 테이블입니다."})]}),e.jsx(p,{classWrap:"table-props",colGroup:e.jsxs(e.Fragment,{children:[e.jsx("col",{className:"table-props-col1"}),e.jsx("col",{className:"table-props-col2"})]}),tHead:e.jsx(e.Fragment,{children:e.jsxs("tr",{children:[e.jsx("th",{children:"props"}),e.jsx("th",{children:e.jsx("div",{className:"table-props-value",children:"value"})}),e.jsx("th",{children:"description"})]})}),classTBody:"table-props",tBody:e.jsxs(e.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{children:"max"}),e.jsx("td",{children:"number"}),e.jsxs("td",{children:["스크린에 나타나는 최대 너비를 설정하는 속성입니다. ",e.jsx("br",{}),"숫자형(number) 타입입니다."]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"min"}),e.jsx("td",{children:"number"}),e.jsxs("td",{children:["스크린에 나타나는 최소 너비를 설정하는 속성입니다. ",e.jsx("br",{}),"숫자형(number) 타입입니다."]})]})]})})]}),e.jsxs("div",{className:"layout-scroll",children:[e.jsx("p",{children:"Content"}),e.jsx("a",{onClick:()=>{t.current.scrollIntoView()},children:" Import"}),e.jsx("a",{onClick:()=>{r.current.scrollIntoView()},children:" Property"}),e.jsx("a",{onClick:()=>{c.current.scrollIntoView()},children:" API"})]})]})})};export{f as default};
