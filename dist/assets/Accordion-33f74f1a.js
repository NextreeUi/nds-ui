import{r,j as s,s as l,B as x}from"./index-593693ad.js";import{R as e}from"./index-731e883c.js";import{j as c}from"./index-f5325f2d.js";import{T as C}from"./Table-917f37d2.js";const i=({wrap:m,title:d,icon:o,iconLocation:t="right",iconRotate:j,children:h,id:p,className:a,click:u})=>{const[n,v]=r.useState(!1),N=()=>{v(!n),u&&u()};return s.jsx(s.Fragment,{children:m?s.jsx("div",{className:l["accordion-wrap"]+" "+(a||""),children:h}):s.jsxs(s.Fragment,{children:[s.jsxs("div",{className:l["accordion-summary"]+" "+(t=="left"?l["icon-left"]:"")+" "+(a||""),id:p,onClick:N,children:[t=="right"?d:s.jsx(s.Fragment,{}),s.jsx("div",{className:n?l[`${j||o||"deg180"}`]:"",children:o||s.jsx("i",{className:l.arrow})}),t=="left"?d:s.jsx(s.Fragment,{})]}),s.jsx("div",{className:l["accordion-detail"]+" "+(n?"":l.close),children:h})]})})},R=()=>{const m=r.useRef(),d=r.useRef(),o=r.useRef(),[t,j]=r.useState(!1),h=()=>{j(!t)},[p,a]=r.useState(!1),u=()=>{a(!p)},[n,v]=r.useState(!1),N=()=>{v(!n)},[A,f]=r.useState(!1),y=()=>{f(!A)};return s.jsx(s.Fragment,{children:s.jsxs("div",{className:"layout-all",children:[s.jsxs("div",{className:"layout-title",children:[s.jsx("h1",{children:"Accordion"}),s.jsx("p",{className:"description",children:"Accordion은 클릭시 확장되는 컴포넌트입니다."})]}),s.jsx("div",{className:"layout-small",children:s.jsxs("div",{className:"layout-title",children:[s.jsx("h2",{ref:m,children:"Import"}),s.jsx("div",{className:"codeMirror",children:s.jsx(e,{theme:"dark",extensions:[c({jsx:!0})],value:`import { Accordion } from 'nds-ui/component';
// or
import Accordion from 'nds-ui/component/Accordion';`})}),s.jsxs("p",{className:"description",children:["임포트 방법은 2가지가 있습니다. ",s.jsx("br",{}),"첫번째 방식은 여러개의 컴포넌트를 임포트하는데 유리합니다. ",s.jsx("br",{}),"임포트 방식은 취향에 맞게 사용하시면 됩니다."]})]})}),s.jsx("div",{className:"layout-small",children:s.jsxs("div",{className:"layout-title",children:[s.jsx("h2",{ref:d,children:"Property"}),s.jsxs("p",{className:"description",children:["Accordion 컴포넌트는 다양한 속성이 있습니다. ",s.jsx("br",{}),"wrap / title / icon / iconLocation / iconRotate 등이 있습니다."]})]})}),s.jsxs("div",{className:"layout-small",children:[s.jsxs("div",{className:"layout-title",children:[s.jsx("h3",{children:"Basic Accordion"}),s.jsxs("p",{className:"description",children:["기본적인 Accordion 형태입니다. ",s.jsx("br",{}),"가장 부모 태그에 wrap 속성을 단 Accorion 컴포넌트로 감싸줍니다. ",s.jsx("br",{}),"자식 Accordion 속성에 title을 달아줍니다. ",s.jsx("br",{}),"확장된 내용은 자식 Accordion 안에 넣어줍니다."]})]}),s.jsx("div",{className:"layout-example",children:s.jsx(i,{wrap:!0,children:s.jsx(i,{title:"아코디언",children:s.jsx("div",{className:"p20",children:" 아코디언 내용입니다."})})})}),s.jsxs("div",{className:"codeMirror",children:[s.jsx("div",{className:"btn-wrap",children:s.jsx(x,{square:!0,radius:"round",variant:"outlined",size:"extraSmall",onClick:h,children:s.jsx("i",{className:"i-code w14 h14"})})}),t?s.jsx(e,{theme:"dark",extensions:[c({jsx:!0})],value:`import * as React from 'react';
...
</>`})]})]}),s.jsxs("div",{className:"layout-small",children:[s.jsxs("div",{className:"layout-title",children:[s.jsx("h2",{ref:o,children:" API "}),s.jsx("p",{className:"description",children:"속성들을 정리한 테이블입니다."})]}),s.jsx(C,{classWrap:"table-props",colGroup:s.jsxs(s.Fragment,{children:[s.jsx("col",{className:"table-props-col1"}),s.jsx("col",{className:"table-props-col2"})]}),tHead:s.jsx(s.Fragment,{children:s.jsxs("tr",{children:[s.jsx("th",{children:"props"}),s.jsx("th",{children:s.jsx("div",{className:"table-props-value",children:"value"})}),s.jsx("th",{children:"description"})]})}),classTBody:"table-props",tBody:s.jsxs(s.Fragment,{children:[s.jsxs("tr",{children:[s.jsx("td",{children:"wrap"}),s.jsx("td",{children:"boolean"}),s.jsxs("td",{children:["Accordion 부모 컴포넌트에 넣는 속성으로 불리언(Boolean) 타입입니다. ",s.jsx("br",{}),"속성값은 따로 없고, 속성을 추가할 시 기본값인 false에서 true로 바뀝니다."]})]}),s.jsxs("tr",{children:[s.jsx("td",{children:"title"}),s.jsxs("td",{children:["string ",s.jsx("br",{}),"element"]}),s.jsx("td",{children:"Accordion 자식 컴포넌트에 넣는 속성으로 문자형(string) 타입이 들어가거나, html 태그를 넣어도 됩니다."})]}),s.jsxs("tr",{children:[s.jsx("td",{children:"icon"}),s.jsx("td",{children:"element"}),s.jsx("td",{children:"확장 아이콘을 변경하는 속성으로 html 태그를 넣습니다."})]}),s.jsxs("tr",{children:[s.jsx("td",{children:"iconLocation"}),s.jsxs("td",{children:["'left'",s.jsx("p",{className:"b",children:"'right'"})]}),s.jsx("td",{children:"확장 아이콘을 위치를 설정하는 속성입니다."})]}),s.jsxs("tr",{children:[s.jsx("td",{children:"iconRotate"}),s.jsxs("td",{children:["'deg90'",s.jsx("p",{className:"b",children:"'deg180'"}),"'deg270'"]}),s.jsx("td",{children:"확장 아이콘을 클릭시 회전각도를 설정하는 속성입니다."})]}),s.jsxs("tr",{children:[s.jsx("td",{children:"click"}),s.jsx("td",{children:"func"}),s.jsx("td",{children:"onClick의 속성의 역할을 수행하는 속성으로 클릭시 실행되는 함수가 들어갑니다."})]})]})})]}),s.jsxs("div",{className:"layout-scroll",children:[s.jsx("p",{children:"Content"}),s.jsx("a",{onClick:()=>{m.current.scrollIntoView()},children:" Import"}),s.jsx("a",{onClick:()=>{d.current.scrollIntoView()},children:" Property"}),s.jsx("a",{onClick:()=>{o.current.scrollIntoView()},children:" API"})]})]})})};export{R as default};
