import{r as n,j as s,B as l}from"./index-f25ddf3a.js";import{R as a,j as r}from"./index-2a00b8a8.js";import{A as e}from"./Avatar-cca47eda.js";import{T as y}from"./Table-7ce808f9.js";const z=()=>{const d=n.useRef(),i=n.useRef(),m=n.useRef(),[c,u]=n.useState(!1),h=()=>{u(!c)},[o,v]=n.useState(!1),p=()=>{v(!o)};n.useState(!1);const[x,b]=n.useState(!1),N=()=>{b(!x)},[t,A]=n.useState(!1),j=()=>{A(!t)};return s.jsx(s.Fragment,{children:s.jsxs("div",{className:"layout-all",children:[s.jsxs("div",{className:"layout-title",children:[s.jsx("h1",{children:"Avatar"}),s.jsx("p",{className:"description",children:"Avatar 컴포넌트입니다."})]}),s.jsx("div",{className:"layout-small",children:s.jsxs("div",{className:"layout-title",children:[s.jsx("h2",{ref:d,children:"Import"}),s.jsx("div",{className:"codeMirror",children:s.jsx(a,{theme:"dark",extensions:[r({jsx:!0})],value:`import { Avatar } from 'nds-ui/component';
// or
