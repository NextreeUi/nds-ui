import{r,j as e,s,B as m}from"./index-ab2469fa.js";import{R as a,j as t}from"./index-8cad6eb6.js";import{T as g}from"./Table-cc32831e.js";const l=({size:i="medium",radius:d="normal",defaultValue:x=0,list:j=["데이터를 입력해주세요"],disabled:h=!1,className:p})=>{const n=j,[f,N]=r.useState(x),S=n[f],[b,o]=r.useState(!1),v=()=>{h==!1&&o(!0)},C=c=>{N(c),o(!1)},y=()=>{o(!1)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:s["select-wrap"]+" "+(p||""),children:[e.jsxs("button",{className:s.select+" "+(b?s.focus:"")+" "+(d=="rect"?s["radius-rect"]:d=="normal"?s["radius-normal"]:d=="round"?s["radius-round"]:"")+" "+(i=="large"?s["size-large"]:i=="medium"?s["size-medium"]:i=="small"?s["size-small"]:i=="extraSmall"?s["size-extraSmall"]:"")+" "+(h?s.disabled:""),onClick:v,children:[S,e.jsx("div",{className:s["select-icon"],children:e.jsx("i",{})})]}),e.jsx("ul",{className:s["select-option"],children:n.map((c,u)=>e.jsx("li",{className:s.option+" "+(u==f?s.active:""),onClick:()=>{C(u)},children:e.jsx("div",{children:c})},u))}),e.jsx("div",{className:s["select-backdrop"],onClick:y})]})})},V=()=>{const i=r.useRef(),d=r.useRef(),x=r.useRef(),[j,h]=r.useState(!1),p=()=>{h(!j)},[n,f]=r.useState(!1),N=()=>{f(!n)},[S,b]=r.useState(!1),o=()=>{b(!S)},[v,C]=r.useState(!1),y=()=>{C(!v)},[c,u]=r.useState(!1),k=()=>{u(!c)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Select"}),e.jsx("p",{className:"description",children:"Select 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:i,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(a,{theme:"dark",extensions:[t({jsx:!0})],value:`import { Select } from 'nds-ui/component';
// or
