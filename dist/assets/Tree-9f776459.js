import{r as a,j as e,s,B as p}from"./index-61f038e9.js";import{R as i}from"./index-e42883c4.js";import{j as l}from"./index-c615d801.js";import{T as N}from"./Table-8b14f5b0.js";const t=({title:n,item:m,icon:r,iconRotate:d,children:u,id:x,onClick:h,className:c})=>{const[o,j]=a.useState(!1),T=()=>{j(!o)};return e.jsx(e.Fragment,{children:m?e.jsxs("div",{className:s["tree-item"]+" "+(c||""),id:x,onClick:h,children:[e.jsx("i",{className:s.item}),n]}):e.jsxs("div",{className:s["tree-wrap"],children:[e.jsxs("div",{className:s["tree-summary"]+" "+(c||""),id:x,onClick:T,children:[e.jsx("div",{className:o?s[`${d||r||"deg90"}`]:"",children:r||e.jsx("i",{className:s.arrow})}),n]}),e.jsx("div",{className:s["tree-detail"]+" "+(o?"":s.close),children:u})]})})},b=()=>{const n=a.useRef(),m=a.useRef(),r=a.useRef(),[d,u]=a.useState(!1),x=()=>{u(!d)},[h,c]=a.useState(!1),o=()=>{c(!h)},[j,T]=a.useState(!1),v=()=>{T(!j)};return e.jsx(e.Fragment,{children:e.jsxs("div",{className:"layout-all",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h1",{children:"Tree"}),e.jsx("p",{className:"description",children:"Tree는 폴더 구조를 나타내는 컴포넌트입니다."})]}),e.jsx("div",{className:"layout-small",children:e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:n,children:"Import"}),e.jsx("div",{className:"codeMirror",children:e.jsx(i,{theme:"dark",extensions:[l({jsx:!0})],value:`import { Tree } from 'nds-ui/component';
// or
...
</>`})]})]}),e.jsxs("div",{className:"layout-small",children:[e.jsxs("div",{className:"layout-title",children:[e.jsx("h2",{ref:r,children:" API "}),e.jsx("p",{className:"description",children:"속성들을 정리한 테이블입니다."})]}),e.jsx(N,{classWrap:"table-props",colGroup:e.jsxs(e.Fragment,{children:[e.jsx("col",{className:"table-props-col1"}),e.jsx("col",{className:"table-props-col2"})]}),tHead:e.jsx(e.Fragment,{children:e.jsxs("tr",{children:[e.jsx("th",{children:"props"}),e.jsx("th",{children:e.jsx("div",{className:"table-props-value",children:"value"})}),e.jsx("th",{children:"description"})]})}),classTBody:"table-props",tBody:e.jsxs(e.Fragment,{children:[e.jsxs("tr",{children:[e.jsx("td",{children:"title"}),e.jsxs("td",{children:["string ",e.jsx("br",{}),"element"]}),e.jsx("td",{children:"제목을 설정하는 속성으로 문자형(string) 타입이 들어가거나, html 태그를 넣어도 됩니다."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"item"}),e.jsx("td",{children:"boolean"}),e.jsxs("td",{children:["가장 하위에 속하는 Tree에 넣는 속성으로 불리언(Boolean) 타입입니다. ",e.jsx("br",{}),"속성값은 따로 없고, 속성을 추가할 시 기본값인 false에서 true로 바뀝니다."]})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"icon"}),e.jsx("td",{children:"element"}),e.jsx("td",{children:"확장 아이콘을 변경하는 속성으로 html 태그를 넣습니다."})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"iconRotate"}),e.jsxs("td",{children:[e.jsx("p",{className:"b",children:"'deg90'"}),"'deg180' ",e.jsx("br",{}),"'deg270'"]}),e.jsx("td",{children:"확장 아이콘을 클릭시 회전각도를 설정하는 속성입니다."})]})]})})]}),e.jsxs("div",{className:"layout-scroll",children:[e.jsx("p",{children:"Content"}),e.jsx("a",{onClick:()=>{n.current.scrollIntoView()},children:" Import"}),e.jsx("a",{onClick:()=>{m.current.scrollIntoView()},children:" Property"}),e.jsx("a",{onClick:()=>{r.current.scrollIntoView()},children:" API"})]})]})})};export{b as default};
